...
/**
 * Alternative usage of EventPoller, here we wrap it around BatchedEventPoller to achieve Disruptor's batching. this speeds up the polling feature
 */
...
class BatchedPoller<T> {
    ...
    private EventPoller.PollState loadNextValues(EventPoller<BatchedPoller.DataEvent<T>> poller, final BatchedData<T> batch) throws Exception {
