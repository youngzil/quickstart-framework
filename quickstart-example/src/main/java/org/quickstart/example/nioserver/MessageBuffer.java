...
/**
 * A shared buffer which can contain many messages inside. A message gets a section of the buffer to use. If the message outgrows the section in size, the message requests a larger section and the
