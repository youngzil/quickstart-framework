...
/**
 * Same as QueueFillCount, except that QueueFlip uses a flip flag to keep track of when the internal writePos has "overflowed" (meaning it goes back to 0). Other than that, the two implementations are
