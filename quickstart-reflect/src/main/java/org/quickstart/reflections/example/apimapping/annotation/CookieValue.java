 ...
 *
 * <p>
 * Supported for annotated chainhandler methods in Servlet and Portlet environments.
 *
 * <p>
 * The method parameter may be declared as type
 * {@link javax.servlet.http.Cookie} or as cookie value type (String, int,
 * etc.).
 *
...
public @interface CookieValue {
	 ...
	 * <p>
	 * Defaults to {@code true}, leading to an exception being thrown if the cookie
	 * is missing in the request. Switch this to {@code false} if you prefer a
	 * {@code null} value if the cookie is not present in the request.
	 * <p>
