...
/**
 * This object contains factory methods for each Java content interface and Java element interface generated in the com.yang.test.webservice.example.client package.
 * <p>
...
public class ObjectFactory {
    ...
    private final static QName _GetValueResponse_QNAME = new QName("http://service.example.webservice.test.yang.com/", "getValueResponse");
    private final static QName _GetValue_QNAME = new QName("http://service.example.webservice.test.yang.com/", "getValue");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.yang.test.webservice.example.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.example.webservice.test.yang.com/", name = "getValueResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.example.webservice.test.yang.com/", name = "getValue")
