 ...
 * @description TODO
 * @createTime 2019/12/15 14:35
 */

/**
 * <p>Utility class that uses {@code java.lang.reflect} standard library.
 * It provides easy access to the standard reflect methods that are needed usually when dealing with generic object types.</p>
 *
...
public class ReflectionUtil {
  ...
  /**
   * {@link Type#toString()} value is the fully qualified class name prefixed with . This method will substring
   ...
   *
   * @param type the {@code Type} object whose its representing {@code Class} object will be instantiated.
   * @return a newly allocated instance of the class represented by the invoked {@code Type} object.
   * @throws ClassNotFoundException if the class represented by this {@code Type} object cannot be located.
   * @throws InstantiationException if this {@code Type} represents an abstract class, an interface, an array class, a primitive type, or void; or if
  ...
  /**
   * Returns an array of {@code Type} objects representing the actual type arguments to this object. If the returned value is null, then this object
  ...
  /**
   * Returns a {@code Class} object that identifies the declared class for the field represented by the given {@code String name} parameter inside the
  ...
  /**
   * Returns a {@code Class} object that identifies the declared class as a return type for the method represented by the given {@code String name}
   * parameter inside the invoked {@code Class<?> clazz} parameter.
   *
   * @param clazz the {@code Class} object whose declared methods to be checked for the wanted method name.
  ...
  /**
   * Extracts the enum constant of the specified enum class with the specified name. The name must match exactly an identifier used to declare an enum
   ...
   * @throws IllegalArgumentException if the specified enum type has no constant with the specified name, or the specified class object does not
