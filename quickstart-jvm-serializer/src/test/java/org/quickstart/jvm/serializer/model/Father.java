package org.quickstart.jvm.serializer.model;
...
public class Father implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (age != father.age)
            return false;
        if (anniversary != father.anniversary)
            return false;
        if (Float.compare(father.cet4Score, cet4Score) != 0)
            return false;
        if (Double.compare(father.cet6Score, cet6Score) != 0)
            return false;
        if (education != father.education)
            return false;
        if (isCCP != father.isCCP)
            return false;
        if (multilingualer != father.multilingualer)
            return false;
        if (phoneNumber != father.phoneNumber)
            return false;
        if (birthday != null ? !birthday.equals(father.birthday) : father.birthday != null)
            return false;
        if (location != null ? !location.equals(father.location) : father.location != null)
            return false;
        if (location_time != null ? !location_time.equals(father.location_time) : father.location_time != null)
            return false;
        if (salary != null ? !salary.equals(father.salary) : father.salary != null)
            return false;
